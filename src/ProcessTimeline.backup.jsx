...
export default function ProcessTimeline() {
    ...
    return (
        <div ref={timelineRef} className='timeline-container flex flex-col items-center w-full max-w-3xl mx-auto py-12'>
                        ...
                        {timelineSteps.slice(0, visibleStep).map((step, idx) => (
                            ...
                            >
                                <div className='flex flex-col items-center'>
                                    <div className='bg-[#202020] rounded-full border-4 border-[#6F47FF] flex items-center justify-center w-16 h-16 mb-2'>
                                        {step.icon}
                                    </div>
                                    {idx < timelineSteps.length - 1 && (
                                        <div className='w-1 h-10 bg-[#6F47FF]/30' />
                                    )}
                                </div>
                                <div className='py-4'>
