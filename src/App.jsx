...
// Fixed header with logo, navigation buttons, and language toggle
function Header() {
...
// Background layers: stars and dot grid
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-5 pointer-events-none">
        <DotGrid dotSize={4} gap={12} baseColor="#000" activeColor="#6F47FF" proximity={120} shockRadius={250} shockStrength={5} resistance={750} returnDuration={1.5} />
      </div>
    </>
  );
}

// Landing page content (hero, about, stats, process, contact)
function Landing() {
  ...
  return (
    <>  
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4">
        <motion.h1 initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-5xl md:text-7xl font-bold text-[#D6D6D6] mb-6 text-center">
          {t('hero.title', 'Take your company to space and beyond')}
        </motion.h1>
        <motion.p initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.8 }} className="text-2xl md:text-3xl text-[#D6D6D6] max-w-2xl text-center mb-8">
